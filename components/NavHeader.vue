<template>
  <header
    class="sticky top-0 z-50 w-full border-b border-white/10 bg-gradient-to-br from-cosmic-haze/85 via-purple-800/60 to-black/70 backdrop-blur-2xl shadow-glass">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-wrap items-center justify-between gap-3 py-3 sm:py-4">
        <!-- Logo -->
        <div class="flex w-full items-center justify-between md:w-auto">
          <nuxt-link to="/" class="flex items-center gap-3 text-slate-100 transition hover:drop-shadow-neon">
            <div
              class="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-lg shadow-purple-500/25">
            ...
            <div>
              ...
              <p class="text-xs text-slate-400 hidden sm:block">Network Intelligence</p>
            </div>
          </nuxt-link>

          <!-- Mobile Menu Button -->
          <button type="button" @click="toggleMenu" :aria-expanded="isMenuOpen ? 'true' : 'false'"
            ...
            <svg v-if="!isMenuOpen" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" stroke="currentColor"
              stroke-width="1.5">
        ...
        <nav class="hidden md:flex items-center gap-3 ml-auto text-sm font-medium text-white/85">
          <button type="button" @click="openSearch"
            ...
            <span
              ...
              <span
                class="absolute -left-8 top-1/2 h-16 w-16 -translate-y-1/2 rounded-full bg-cosmic-flare/35 blur-2xl"></span>
              <span class="absolute -right-6 -top-6 h-14 w-14 rounded-full bg-cosmic-aurora/40 blur-2xl"></span>
            </span>
            <span class="relative z-10 flex items-center gap-3">
              <span
                class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-cosmic-aurora/80 to-sky-500/80 text-white shadow-glass">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5">
                  <path stroke-linecap="round" stroke-linejoin="round"
                    d="M21 21l-4.35-4.35m1.1-4.3a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0Z" />
                </svg>
              </span>
              <span>Search</span>
              <svg class="h-4 w-4 text-white/50 transition group-hover:translate-x-1 group-hover:text-white"
          ...
          <nuxt-link to="/trends"
            ...
            <span
              class="pointer-events-none absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100">
              <span
                class="absolute -left-8 top-1/2 h-16 w-16 -translate-y-1/2 rounded-full bg-cosmic-aurora/40 blur-2xl"></span>
              <span class="absolute -right-6 -top-6 h-14 w-14 rounded-full bg-cosmic-flare/35 blur-2xl"></span>
            </span>
            <span class="relative z-10 flex items-center gap-3">
              <span
                class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-cosmic-aurora/80 to-cosmic-flare/80 text-white shadow-glass">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5">
          ...
          <nuxt-link to="/live/scan"
            class="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 text-white/80 transition duration-300 hover:-translate-y-0.5 hover:border-cosmic-aurora/70 hover:text-white hover:shadow-glow">
            <span
              class="pointer-events-none absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100">
              <span
                class="absolute -left-8 top-1/2 h-16 w-16 -translate-y-1/2 rounded-full bg-green-400/45 blur-2xl"></span>
              <span class="absolute -right-6 -top-6 h-14 w-14 rounded-full bg-emerald-400/35 blur-2xl"></span>
            </span>
            <span class="relative z-10 flex items-center gap-3">
              <span
                class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-green-400/80 to-emerald-400/80 text-white shadow-glass">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5">
                  <path stroke-linecap="round" stroke-linejoin="round"
                    d="M9.348 14.652a3.75 3.75 0 0 1 0-5.304m5.304 0a3.75 3.75 0 0 1 0 5.304m-7.425 2.121a7.5 7.5 0 0 1 0-10.606m9.546 0a7.5 7.5 0 0 1 0 10.606M12 12h.008v.008H12V12Z" />
                </svg>
              </span>
              <span>Live Scan</span>
              <svg class="h-4 w-4 text-white/50 transition group-hover:translate-x-1 group-hover:text-white"
          ...
          <nuxt-link to="/ipv4"
            ...
            <span
              class="pointer-events-none absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100">
              <span
                class="absolute -left-8 top-1/2 h-16 w-16 -translate-y-1/2 rounded-full bg-indigo-400/45 blur-2xl"></span>
              <span class="absolute -right-6 -top-6 h-14 w-14 rounded-full bg-sky-500/35 blur-2xl"></span>
            </span>
            <span class="relative z-10 flex items-center gap-3">
              <span
                class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-400/80 to-sky-500/80 text-white shadow-glass">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5">
          ...
          <nuxt-link to="/dns"
            ...
            <span
              class="pointer-events-none absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100">
              <span
                class="absolute -left-8 top-1/2 h-16 w-16 -translate-y-1/2 rounded-full bg-cyan-400/45 blur-2xl"></span>
              <span class="absolute -right-6 -top-6 h-14 w-14 rounded-full bg-emerald-400/35 blur-2xl"></span>
            </span>
            <span class="relative z-10 flex items-center gap-3">
              <span
                class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-400/80 to-emerald-400/80 text-white shadow-glass">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5">
                  <path stroke-linecap="round" stroke-linejoin="round"
                    d="M12 3v4m0 10v4m7-7h-4M9 12H5m12-5.657-2.828 2.829M8.828 15.172 6 18m12 .001-2.828-2.829M8.828 8.829 6 6" />
                </svg>
              </span>
              <span>DNS</span>
              <svg class="h-4 w-4 text-white/50 transition group-hover:translate-x-1 group-hover:text-white"
          ...
          <nuxt-link to="/asn"
            ...
            <span
              class="pointer-events-none absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100">
              <span
                class="absolute -left-8 top-1/2 h-16 w-16 -translate-y-1/2 rounded-full bg-rose-400/45 blur-2xl"></span>
              <span class="absolute -right-6 -top-6 h-14 w-14 rounded-full bg-orange-400/35 blur-2xl"></span>
            </span>
            <span class="relative z-10 flex items-center gap-3">
              <span
                class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-rose-400/80 to-orange-400/80 text-white shadow-glass">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5">
      ...
      <Transition enter-active-class="transition duration-200 ease-out" enter-from-class="opacity-0 -translate-y-2"
        ...
        <div v-if="isMenuOpen" class="md:hidden pb-4" id="mobile-menu">
          <div
            class="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-cosmic-haze/50 via-purple-900/60 to-black/70 p-5 shadow-glass backdrop-blur-2xl">
            <div class="pointer-events-none absolute inset-0 -z-10 opacity-80">
              <div
                class="absolute -top-24 left-1/2 h-48 w-48 -translate-x-1/2 rounded-full bg-cosmic-aurora/60 blur-[120px]">
              </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-slate-400">Navigate the dataset</p>
                  </div>
                </div>
                <span
                  class="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-white/15 bg-white/10 text-white/80 shadow-glow">
                  <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round"
                      d="m10.5 6.75 1.5-1.5 1.5 1.5m0 10.5-1.5 1.5-1.5-1.5M6.75 10.5l-1.5 1.5 1.5 1.5m10.5 0 1.5-1.5-1.5-1.5M9 9h6v6H9z" />
                  </svg>
                </span>
              </div>
